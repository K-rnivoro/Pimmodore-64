...
Also, using a Converter, prevents the "voltage drop" of the connector and switch. Believe , I've experimented with 5VDC Power Supllies and I've always had the lighting bolt sign of the Pi, so connecting directly to a 5VDC Power Supply is not advisable (even "Raspberry Certified"). Also, being a Step Down, do not use any PS lower than 6V!
